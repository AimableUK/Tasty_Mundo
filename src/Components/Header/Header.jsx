...
export default function Header() {
  return (
    <header className="z-10 text-white w-full fixed flex flex-col md:flex-row pt-2 gap-2 justify-between md:p-3 md:gap-10 pb-2 md:pl-20 md:pr-20 items-center border-b border-gray-700">
