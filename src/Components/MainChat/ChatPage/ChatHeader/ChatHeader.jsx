...
const ChatHeader = ({
  ...
  return (
    <div className="z-20 fixed flex flex-row p-1 md:py-3 px-2 md:px-4 md:ml-14 justify-between w-full border-b border-b-gray-700 items-center bg-primaryBody md:border-l border-l-gray-700">
      ...
      <div className="relative flex flex-row flex-nowrap items-center md:mr-14">
        <svg
          ...
          className="md:hidden size-7 self-center text-gray-300 cursor-pointer hover:bg-gray-700 active:bg-inherit transform duration-100 ease-in-out rounded-md p-1"
        >
          <path
            fill="currentColor"
            fillRule="nonzero"
        ...
        <svg
          ...
          className="md:hidden size-8 cursor-pointer text-gray-300 hover:bg-gray-700
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          onClick={newChat}
          className="md:hidden bx  bx-edit-alt size-9 cursor-pointer text-gray-300 hover:bg-gray-700
        ...
        {showMore && (
          <div
            ref={dropdownRef}
            className="items-stretch flex absolute right-1 top-9 md:top-4 flex-col border border-gray-800 gap-y-1 rounded-md p-1 bg-gray-900"
          >
            <Link to="/">
