...
const ChatHeader = ({
  ...
  const canDelete = !!chatId && chatId.trim() !== "";
          ...
          >
            ...
            {canDelete && (
              <button
                ...
                className="flex flex-row flex-nowrap items-center hover:text-red-400 font-semibold border-gray-900 hover:bg-gray-800 rounded-md p-1 px-2 gap-1 transition-all duration-200 ease-in-out active:scale-95"
              >
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
