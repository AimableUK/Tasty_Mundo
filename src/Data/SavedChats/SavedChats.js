const SavedChats = [
  {
    id: 1,
    chatName: "Spicy Cabbage Stir Fry",
    ingredients: ["cabbage", "onion", "chili flakes", "oil"],
  ...
  {
    id: 2,
    chatName: "Sweet Potato Delight",
    ingredients: ["sweet potatoes", "honey", "cinnamon"],
  ...
  {
    id: 3,
    chatName: "Creamy Avocado Pasta",
    ingredients: ["avocado", "garlic", "pasta", "lemon juice"],
  ...
  {
    id: 4,
    chatName: "Quick Egg Toast",
    ingredients: ["eggs", "bread", "salt", "butter"],
  ...
  {
    id: 5,
    chatName: "Zesty Pineapple Salad",
    ingredients: ["pineapple", "mint", "lime", "salt"],
  ...
  {
    id: 6,
    chatName: "Savory Rice Omelette",
    ingredients: ["rice", "eggs", "onions", "pepper"],
  ...
  {
    id: 7,
    chatName: "Yam and Bean Stew",
    ingredients: ["yams", "beans", "tomato paste", "garlic"],
  ...
  {
    id: 8,
    chatName: "Herby Lentil Soup",
    ingredients: ["lentils", "carrots", "celery", "thyme"],
  ...
  {
    id: 9,
    chatName: "Crunchy Mango Slaw",
    ingredients: ["mango", "cabbage", "vinegar", "sugar"],
  ...
  {
    id: 10,
    chatName: "Eggplant Curry Quickie",
    ingredients: ["eggplant", "coconut milk", "curry powder"],
  ...
  {
    id: 11,
    chatName: "Fresh Corn Fritters",
    ingredients: ["corn", "flour", "eggs", "baking powder"],
  ...
  {
    id: 12,
    chatName: "Papaya Ginger Smoothie",
    ingredients: ["papaya", "ginger", "yogurt", "honey"],
  ...
  {
    id: 13,
    chatName: "Simple Banana Pancakes",
  ...
  {
    id: 14,
    chatName: "Garlic Tomato Pasta",
    ingredients: ["tomatoes", "garlic", "pasta", "olive oil"],
  ...
  {
    id: 15,
    chatName: "Rainbow Veggie Stir Fry",
